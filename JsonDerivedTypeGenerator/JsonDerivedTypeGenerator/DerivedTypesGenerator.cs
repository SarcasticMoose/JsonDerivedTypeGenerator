    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(compilationAndTypes, (spc, source) =>
        {
            ...
            foreach (var baseType in baseTypes)
            {
                ...
                {
                    sb.AppendLine($"[JsonDerivedType(typeof({derivedType.OriginalDefinition}), \"{derivedType.Name}\")]");
                }

                sb.AppendLine($"public partial class {baseType.Key.Name} {{ }}");
                spc.AddSource($"{baseType.Key.Name}_JsonDerivedTypes.g.cs", SourceText.From(sb.ToString(), Encoding.UTF8));
            }
        });
    }
}